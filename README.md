...
<p>Estando os atributos organizados, devemos em seguida utilizar a anotação @FieldReader para marcar os atributos a serem extraídos e informar alguns parâmetros para que a extração aconteça de forma correta. 
